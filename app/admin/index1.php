...
<div class="wrapper">
    ...
    <header class="main-header">
        <div class="d-flex align-items-center logo-box justify-content-start">
            ...
            <!-- Logo -->
            <a href="#" class="logo justify-content-around">
                <!-- logo-->
                <div class="logo-lg">
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu animated flipInX">
                                <li class="user-body">
                                    ...
                                    <a class="dropdown-item" href="../includes/auth.php?action=logout"><i class="ti-lock text-muted me-2"></i> Logout</a>
                                </li>
                            </ul>
                        </li>	
            ...
            <section class="content">			
                <div class="row">
                                    ...
                                    <div class="d-lg-flex justify-content-between align-items-center">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="d-flex flex-column fw-500">
                                                <a href="#" class="text-white hover-success fs-16">$800</a>
                        ...
                        <div class="box">
                            <div class="box-header">
                                ...
                                <div class="box-controls pull-right">
                                    <a href="#" class="btn btn-primary btn-xs">Daily</a>
                                </div>
                            </div>
                            <div class="box-body">
                                <div class="row">
                                    ...
                                    <div class="col-12 d-flex flex-column mt-20">
                                        <div class="flex-grow-1 bg-danger p-30 flex-grow-1 bg-img" style="background-position: calc(100% + 0.5rem) bottom; background-size: auto 100%; background-image: url(https://powerbi-admin-template.multipurposethemes.com/bs5/images/svg-icon/color-svg/custom-3.svg)">
                    ...
                    <div class="col-lg-4 col-12">
                        <div class="box bg-img" style="background-image: url(https://powerbi-admin-template.multipurposethemes.com/bs5/images/abstract-1.svg);background-position: right top; background-size: 30% auto;">
                            <div class="box-body">
                    ...
                    <div class="col-lg-4 col-12">
                        <div class="box bg-img bg-info-light" style="background-image: url(https://powerbi-admin-template.multipurposethemes.com/bs5/images/abstract-2.svg);background-position: right top; background-size: 30% auto;">
                            <div class="box-body">
                    ...
                    <div class="col-lg-4 col-12">
                        <div class="box bg-img" style="background-image: url(https://powerbi-admin-template.multipurposethemes.com/bs5/images/abstract-3.svg);background-position: right top; background-size: 30% auto;">
                            <div class="box-body">
                    ...
                    <div class="col-xl-8 col-12">
                        <div class="row">						
                                ...
                                <div class="box">
                                    <div class="box-body">	
                                        <div class="d-flex flex-wrap align-items-center">							
                                            <div class="me-10 bg-danger-light h-80 w-80 l-h-80 rounded text-center">
                                                <img src="https://powerbi-admin-template.multipurposethemes.com/bs5/images/svg-icon/color-svg/002-google.svg" class="h-50 align-self-center" alt="">
                                            </div>
                                            <div class="d-flex flex-column flex-grow-1 my-lg-0 my-10">
                                                <a href="#" class="text-dark fw-600 hover-danger fs-16 mb-5">
                                                    Contrary to popular belief<br>
                                                    Typesetting Industry
                                                </a>
                                                <span class="text-fade fw-600 fs-14">
                                                    15 Jan 2020
                                                </span>
                                            </div>
                                            <div class="d-flex flex-column w-p100 mt-35">
                            ...
                            <div class="col-xl-6">
                                <div class="box">
                                    <div class="box-body d-flex p-0">
                                        <div class="flex-grow-1 bg-info px-30 pt-50 pb-60 flex-grow-1 bg-img min-h-300" style="background-position: right bottom; background-size: 40% auto; background-image: url(https://powerbi-admin-template.multipurposethemes.com/bs5/images/svg-icon/color-svg/custom-6.svg)">
                                            <h3 class="fw-600">Start Now</h3>
                                            <p class="py-15 fs-16">
                            ...
                            <div class="col-12"> 
                                <div class="box">
                                    <div class="box-body d-flex p-0">
                                        <div class="flex-grow-1 bg-warning-light p-30 flex-grow-1 bg-img" style="background-position: left bottom; background-size: auto 100%; background-image: url(https://powerbi-admin-template.multipurposethemes.com/bs5/images/svg-icon/color-svg/custom-2.svg)">
                                            <div class="row">
                                                <div class="col-12 col-lg-5"></div>
                                                <div class="col-12 col-lg-7">
                                                    <h4 class="text-warning fw-600">Join Us now to get 15% off</h4>
                        ...
                        <div class="box">		
                            ...
                            <div class="box-body">
                                ...
                                <p class="text-center fs-16 pb-20">
                                    Notes: There are many variations of <br>
