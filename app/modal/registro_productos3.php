...
<!-- The Modal -->
<div class="modal" id="registro_producto3">
  <div class="modal-dialog ">
    <div class="modal-content">
      ...
      <form class="form-horizontal" method="post" id="guardar_producto2" name="guardar_producto2">
			<div id="resultados_ajax_productos2"></div>
