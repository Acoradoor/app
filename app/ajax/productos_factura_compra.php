...
if($action == 'ajax'){
    ...
    $q = strip_tags($_REQUEST['q_compras'], ENT_QUOTES);
    ...
    $page = (isset($_REQUEST['page_compras']) && !empty($_REQUEST['page_compras']))?$_REQUEST['page_compras']:1;
          ...
          <table class="table">
            ...
            while ($row=$query->fetch(PDO::FETCH_ASSOC)){
                ...
                <tr>
                    ...
                    <input type="text" class="form-control" style="text-align:right" id="cantidadfc_<?php echo $id_producto; ?>"  value="1" >
                    </div></td>
                    <td class='col-xs-2'><div class="pull-right">
                    <input type="text" class="form-control" style="text-align:right" id="precio_ventafc_<?php echo $id_producto; ?>"  value="<?php echo $precio_venta1;?>" >
                    </div></td>
