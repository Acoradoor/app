...
if (!isset($numero_factura) || !isset($id_proveedor) || !isset($session_id)) {
...
<?php 
// Incluir encabezado
include("encabezado_factura_compras.php"); 
?>
<br><br><br><br>
...
<table cellspacing="0" style="width: 100%; text-align: left; font-size: 11pt;">
    ...
    <tr>
        <td style="width:40%;">
            <?php 
            try {
                // Consulta PDO para obtener datos del proveedor
                $sql_proveedor = $conn->prepare("SELECT * FROM proveedores WHERE id_proveedor = :id_proveedor");
                $sql_proveedor->execute([':id_proveedor' => $id_proveedor]);
                $rw_proveedor = $sql_proveedor->fetch(PDO::FETCH_ASSOC);
                ...
                if ($rw_proveedor) {
                    ...
                    echo "<br> NIF / CIF:  ";
                    echo $rw_proveedor['cif'];
                    echo "<br> Teléfono: ";
                    echo $rw_proveedor['telefono_movil'];
                    echo "<br> Email: ";
                ...
                echo "Error al obtener datos del proveedor";
            }
            ?>
        </td>
    </tr>
...
<?php 
        // Insertar en detalle_factura_compras usando PDO
        try {
            $insert_detail = $conn->prepare("INSERT INTO detalle_factura_compras (numero_factura_compra, id_producto, cantidad, precio_venta) VALUES (:numero_factura_compra, :id_producto, :cantidad, :precio_venta)");
...
try {
    ...
    $insert = $conn->prepare("INSERT INTO facturas_compras (numero_factura_compra, fecha_factura_compra, id_proveedor, id_vendedor, condiciones, total_venta, descuento, estado_factura) VALUES (:numero_factura_compra, :date, :id_proveedor, :id_vendedor, :condiciones, :total_venta, :descuento, '2')");
    $insert->execute([
        ':numero_factura_compra' => $numero_factura,
        ':date' => $date,
